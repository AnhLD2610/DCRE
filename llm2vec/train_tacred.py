...
class Manager(object):
    ...
    def train_model(self, encoder, training_data, seen_des, is_memory=False):
        ...
        for i in range(epoch):
            for batch_num, (instance, labels, ind) in enumerate(data_loader):
                ...
                labels_des = encoder(batch_instance) # b, dim
    ...
    def train(self):
        ...
        for step, (training_data, valid_data, test_data, current_relations, \
            ...
            seen_des_by_id = {} # dict key la id value la description
            for rel in seen_relations:
                seen_des_by_id[self.rel2id[rel]] = seen_des[rel]['input']
            list_seen_des = []
